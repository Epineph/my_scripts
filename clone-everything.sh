#!/usr/bin/env bash
# Auto-generated clone script – 2025-05-23T08:38:36+02:00
set -euo pipefail
...
repos=(
  ...
  "autotools-language-server https://github.com/Freed-Wu/autotools-langu
age-server.git"
...
.git"
  ...
  "generate_install_command https://github.com/Epineph/generate_install_
command"
  ...
  "micromamba-releases https://github.com/mamba-org/micromamba-releases.
git"
...
git"
  ...
  "openscad-language-server https://github.com/dzhu/openscad-language-se
rver.git"
  ...
  "pascal-language-server https://github.com/genericptr/pascal-language-
server.git"
...
"
  ...
  "SublimeAllAutocomplete https://github.com/alienhard/SublimeAllAutocom
plete.git"
...
"
  ...
  "tree-sitter-phpdoc https://github.com/claytonrcarter/tree-sitter-phpd
oc.git"
  "UserScripts https://github.com/Epineph/UserScripts"
  "vcpkg https://github.com/microsoft/vcpkg.git"
  "vim-lsp https://github.com/prabirshrestha/vim-lsp.git"
  "visual-studio-code-bin https://aur.archlinux.org/visual-studio-code-b
in.git"
