...
show_help() {
  if command -v bat >/dev/null 2>&1; then
    # Pipe the help text into bat with the desired options.
    cat <<EOF | bat --style="grid,header,snip" --theme-dark="Dracula" --language="help" --force-colorization --chop-long-lines --squeeze-blank --squeeze-limit=2 --paging=never --italic-text=always --tabs=2
Usage: $0 [searchTerm]
