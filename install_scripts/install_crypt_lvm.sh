...
parted -s "$DISK" mkpart primary ext4 513MiB 1025MiB
...
Save this script as install-arch.sh and make it executable:
...
This script will automate the installation process. Ensure you modify the placeholders such as Region/City for the time zone and password for the root password accordingly. If you have specific requirements for your keyboard layout or additional packages, adjust the script accordingly.